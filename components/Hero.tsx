...
import { PROFILE_IMG_B64 } from '../constants';
      ...
      <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center">
        <div className="order-last md:order-first text-center md:text-left">
            <div className="space-y-6">
                ...
                <h2 className="text-xl md:text-3xl font-semibold text-teal-400">
                Software Engineer | Full-Stack Developer | AI & ML Enthusiast
                </h2>
                <p className="text-lg md:text-xl text-gray-300 max-w-3xl">
                I build scalable, cloud-ready applications and solve complex problems with clean, efficient code. Currently specializing in backend systems and machine learning.
                </p>
                <div className="flex flex-col sm:flex-row items-center justify-center md:justify-start gap-4 pt-4">
                <a
                    href="#projects"
                    className="w-full sm:w-auto bg-teal-500 hover:bg-teal-600 text-white font-bold py-3 px-8 rounded-full transition duration-300 ease-in-out transform hover:scale-105"
                >
                    View Projects
                </a>
                <a
                    ...
                    download
                    className="w-full sm:w-auto bg-gray-700 hover:bg-gray-600 text-white font-bold py-3 px-8 rounded-full transition duration-300 ease-in-out transform hover:scale-105"
                >
                    Download Resume
                </a>
                </div>
        ...
        <div className="flex justify-center md:justify-end order-first md:order-last">
            <div className="relative w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96">
                <div className="absolute inset-0 bg-teal-500 rounded-full blur-2xl opacity-40"></div>
                <img 
                    src={PROFILE_IMG_B64} 
                    alt="Sathyam" 
                    className="relative rounded-full w-full h-full object-cover border-4 border-teal-400 shadow-2xl"
                />
            </div>
        </div>
      </div>
